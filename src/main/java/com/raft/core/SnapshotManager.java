...
public class SnapshotManager {
    ...
    public boolean loadSnapshot() {
        ...
        try {
            ...
            log.info("Loaded snapshot: lastIncludedIndex={}, lastIncludedTerm={}, keys={}",
                    lastIncludedIndex, lastIncludedTerm, lastSnapshotData.size());
            return true;
        } catch (IOException e) {
    ...
    /**
     * Take a snapshot: save state machine to disk and compact the log.
     */
    ...
    public void installSnapshot(int lastIndex, int lastTerm,
        ...
        log.info("Installed snapshot from leader: index={}, term={}, keys={}",
                lastIndex, lastTerm, lastSnapshotData.size());
    }
